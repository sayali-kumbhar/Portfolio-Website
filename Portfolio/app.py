...
img_flight_fare=Image.open(r"image/flight fare prediction.jpg")
img_health_expense=Image.open(r"image/healthcare.png")
img_twitter_sentiment=Image.open(r"image/twitter sentiment analysis.jpg")
img_fake_news= Image.open(r"image/fake news.jpg")
img_stress_detection=Image.open(r"image/stress detection.jpg")
img_hackerrank_profile=Image.open(r"image/Hackerrank Profile.png")
img_gilbert_research=Image.open(r"image/gilbert research centre.png")
img_applied_AI=Image.open(r"image/Applied AI.png")
